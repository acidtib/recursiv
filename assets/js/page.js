...
var loadBackground = function() {
	...
	images = preload({
			phobos: '/assets/img/phobos.jpg',
			scanlines: '/assets/img/scanlines.png',
			vignette: '/assets/img/vignette.png',
			dustNear: '/assets/img/dust-near.jpg',
			dustFar: '/assets/img/dust-far.jpg'
		}, function() {
			startTime = Date.now();
